...
public class mcreator_tuberculos extends nebulus.ModElement {
	...
	static {
		portal = (BlockCustomPortal) (new BlockCustomPortal().setUnlocalizedName("tuberculos_portal"));
		block = (ModTrigger) (new ModTrigger().setUnlocalizedName("tuberculos_trigger"));
	}
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("nebulus:tuberculos_trigger", "inventory"));
		}
	}

	@Override
	public void preInit(FMLPreInitializationEvent event) {
		portal.setRegistryName("tuberculos_portal");
		...
		block.setRegistryName("tuberculos_trigger");
		ForgeRegistries.ITEMS.register(block);
		dtype = DimensionType.register("tuberculos", "_tuberculos", DIMID, WorldProviderMod.class, true);
					...
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag
									? mcreator_nebuliteMeteorinner.block.getDefaultState()
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != mcreator_nebuliteMeteorinner.block.getDefaultState()
									.getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == mcreator_nebuliteMeteorinner.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != mcreator_nebuliteMeteorinner.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != mcreator_nebuliteMeteorinner.block
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {mcreator_tuberculosiaPlains.biome, mcreator_tuberculosia.biome,};
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = mcreator_celestialrock.block.getDefaultState();
		protected static final IBlockState GRAVEL = mcreator_celestialrock.block.getDefaultState();
			...
			}
			{
				if ((rand.nextInt(1000000) + 1) <= 102) {
					...
					Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
							new ResourceLocation("nebulus", "solroot_tree"));
					if (template == null)
						return;
