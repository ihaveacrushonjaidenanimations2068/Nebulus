...
public class mcreator_volcanicDeserts extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("volcanicDeserts");
		properties.setRainfall(0.5F);
		properties.setBaseHeight(0.1F);
		properties.setHeightVariation(0.2F);
		properties.setTemperature(0.5F);
		properties.setWaterColor(-16711681);
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("volcanicDeserts");
			topBlock = mcreator_volcanicSand.block.getDefaultState();
			fillerBlock = mcreator_volcanicSand.block.getDefaultState();
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random par2Random, BlockPos pos) {
			...
			Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
					new ResourceLocation("nebulus", "volcanic_stalagmite"));
			if (template == null)
				return false;
			Block ground = world.getBlockState(pos).getBlock();
			Block ground2 = world.getBlockState(pos.add(0, -1, 0)).getBlock();
			if (!(ground == mcreator_volcanicSand.block.getDefaultState().getBlock()
					|| ground == mcreator_volcanicSand.block.getDefaultState().getBlock()
					|| ground2 == mcreator_volcanicSand.block.getDefaultState().getBlock() || ground2 == mcreator_volcanicSand.block
