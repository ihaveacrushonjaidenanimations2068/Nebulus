...
public class mcreator_nebuForest extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("nebuForest");
		properties.setRainfall(0.5F);
		properties.setBaseHeight(0.1F);
		properties.setHeightVariation(0.2F);
		properties.setTemperature(0.5F);
		properties.setWaterColor(-16724788);
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("nebuForest");
			topBlock = mcreator_nebulizedgrass.block.getDefaultState();
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random par2Random, BlockPos pos) {
			...
			if (!(ground == mcreator_nebulizedgrass.block.getDefaultState().getBlock()
					|| ground == mcreator_dullNebulizedDirt.block.getDefaultState().getBlock()
					|| ground2 == mcreator_nebulizedgrass.block.getDefaultState().getBlock() || ground2 == mcreator_dullNebulizedDirt.block
