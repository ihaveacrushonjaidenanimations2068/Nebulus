...
public class mcreator_tuberculosiaPlains extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("tuberculosiaPlains");
		properties.setRainfall(0.5F);
		properties.setBaseHeight(0.1F);
		properties.setHeightVariation(0.2F);
		properties.setTemperature(0.5F);
		properties.setWaterColor(-3355444);
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("tuberculosiaPlains");
			topBlock = mcreator_celestialgrass.block.getDefaultState();
			...
			this.spawnableCreatureList.add(new SpawnListEntry(mcreator_tracker.Entitytracker.class, 40, 1, 5));
		}
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random par2Random, BlockPos pos) {
			...
			if (!(ground == mcreator_celestialgrass.block.getDefaultState().getBlock()
					|| ground == mcreator_dullNebulizedDirt.block.getDefaultState().getBlock()
					|| ground2 == mcreator_celestialgrass.block.getDefaultState().getBlock() || ground2 == mcreator_dullNebulizedDirt.block
