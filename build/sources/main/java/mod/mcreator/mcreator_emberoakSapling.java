...
public class mcreator_emberoakSapling extends nebulus.ModElement {

	public static Block block;
	static {
		block = (Block) (new BlockCustomFlower()).setHardness(0.01F).setResistance(2F).setLightLevel(0F).setUnlocalizedName("emberoaksapling");
	}

	@Override
	public void preInit(FMLPreInitializationEvent event) {
		block.setRegistryName("emberoaksapling");
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nebulus:emberoaksapling", "inventory"));
		}
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side,
			...
			int z = pos.getZ();
			{
				...
				mcreator_emberoakSaplingOnBlockRightclicked.executeProcedure($_dependencies);
			}
			return true;
		}
