...
public class mcreator_etherealPlains extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("etherealPlains");
		properties.setRainfall(0.5F);
		properties.setBaseHeight(0.1F);
		properties.setHeightVariation(0.2F);
		properties.setTemperature(0.5F);
		properties.setWaterColor(-16711783);
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("etherealPlains");
			topBlock = mcreator_etherealGrass.block.getDefaultState();
			fillerBlock = mcreator_etherealStone.block.getDefaultState();
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random par2Random, BlockPos pos) {
			...
			if (!(ground == mcreator_etherealGrass.block.getDefaultState().getBlock()
					|| ground == mcreator_etherealStone.block.getDefaultState().getBlock()
					|| ground2 == mcreator_etherealGrass.block.getDefaultState().getBlock() || ground2 == mcreator_etherealStone.block
