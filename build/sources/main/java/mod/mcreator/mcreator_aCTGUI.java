...
public class mcreator_aCTGUI extends nebulus.ModElement {
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.addSlotToContainer(new Slot(inherited, 2, 107, 39) {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("actgui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Ice Melter", 43, 11, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 52, this.guiTop + 38, 38, 20, "Melt"));
		}
			...
			if (button.id == 0) {
				{
					...
					mcreator_aCTGUIOnButtonClicked.executeProcedure($_dependencies);
				}
			}
		}
