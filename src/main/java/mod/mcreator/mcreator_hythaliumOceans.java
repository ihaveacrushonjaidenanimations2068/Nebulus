...
public class mcreator_hythaliumOceans extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("hythaliumOceans");
		properties.setRainfall(0.5F);
		properties.setBaseHeight(-0.01F);
		properties.setHeightVariation(0F);
		properties.setTemperature(0.5F);
		properties.setWaterColor(-16777216);
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("hythaliumOceans");
			topBlock = mcreator_hythaliumDistilledWater.block.getDefaultState();
			fillerBlock = mcreator_hythaliumDistilledWater.block.getDefaultState();
			...
			this.spawnableCreatureList.add(new SpawnListEntry(mcreator_hythalumTurtle.EntityhythalumTurtle.class, 40, 1, 5));
		}
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random par2Random, BlockPos pos) {
			...
			Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
					new ResourceLocation("nebulus", "big_hythalium_coral"));
			if (template == null)
				return false;
			Block ground = world.getBlockState(pos).getBlock();
			Block ground2 = world.getBlockState(pos.add(0, -1, 0)).getBlock();
			if (!(ground == mcreator_hythaliumDistilledWater.block.getDefaultState().getBlock()
					|| ground == mcreator_hythaliumDistilledWater.block.getDefaultState().getBlock()
					|| ground2 == mcreator_hythaliumDistilledWater.block.getDefaultState().getBlock() || ground2 == mcreator_hythaliumDistilledWater.block
