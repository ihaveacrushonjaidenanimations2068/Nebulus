...
public class mcreator_choleratisIV extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("choleratisIV");
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("choleratisIV");
			topBlock = mcreator_choleraStone.block.getDefaultState();
			fillerBlock = mcreator_choleraStone.block.getDefaultState();
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random par2Random, BlockPos pos) {
			...
			if (!(ground == mcreator_choleraStone.block.getDefaultState().getBlock()
					|| ground == mcreator_choleraStone.block.getDefaultState().getBlock()
					|| ground2 == mcreator_choleraStone.block.getDefaultState().getBlock() || ground2 == mcreator_choleraStone.block
