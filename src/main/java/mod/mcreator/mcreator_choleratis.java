...
public class mcreator_choleratis extends nebulus.ModElement {
	...
	static {
		portal = (BlockCustomPortal) (new BlockCustomPortal().setUnlocalizedName("choleratis_portal"));
		block = (ModTrigger) (new ModTrigger().setUnlocalizedName("choleratis_trigger"));
	}
	...
	public void load(FMLInitializationEvent event) {
		if (event.getSide() == Side.CLIENT) {
			Minecraft.getMinecraft().getRenderItem().getItemModelMesher()
					.register(block, 0, new ModelResourceLocation("nebulus:choleratis_trigger", "inventory"));
		}
	}

	@Override
	public void preInit(FMLPreInitializationEvent event) {
		portal.setRegistryName("choleratis_portal");
		...
		block.setRegistryName("choleratis_trigger");
		ForgeRegistries.ITEMS.register(block);
		dtype = DimensionType.register("choleratis", "_choleratis", DIMID, WorldProviderMod.class, true);
					...
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							this.world.setBlockState(new BlockPos(i2, j2, k2),
									flag ? mcreator_dullNebulizedDirt.block.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag
									? mcreator_dullNebulizedDirt.block.getDefaultState()
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != mcreator_dullNebulizedDirt.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == mcreator_dullNebulizedDirt.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != mcreator_dullNebulizedDirt.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != mcreator_dullNebulizedDirt.block
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {mcreator_choleratisIV.biome,};
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = mcreator_choleraStone.block.getDefaultState();
		protected static final IBlockState LAVA = mcreator_solurton.block.getDefaultState();
		protected static final IBlockState GRAVEL = mcreator_nEbuliteMeteorouter.block.getDefaultState();
		protected static final IBlockState SOUL_SAND = mcreator_choleraStone.block.getDefaultState();
		private final WorldGenerator quartzGen = new WorldGenMinable(mcreator_cheripiteOre.block.getDefaultState(), 14, BlockMatcher.forBlock(STONE
				.getBlock()));
