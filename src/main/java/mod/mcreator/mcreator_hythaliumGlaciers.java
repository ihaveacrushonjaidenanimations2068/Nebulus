...
public class mcreator_hythaliumGlaciers extends nebulus.ModElement {

	public static BiomeGenCustom biome;
	static {
		Biome.BiomeProperties properties = new Biome.BiomeProperties("hythaliumGlaciers");
	...
	static class BiomeGenCustom extends Biome {
		...
		public BiomeGenCustom(Biome.BiomeProperties properties) {
			super(properties);
			setRegistryName("hythaliumGlaciers");
